...
def get_integrate_system_explicit_asynchronous(mu,lam,gamma):
    ...
    @njit
    def integrate_system_explicit_asynchronous(tf, element_array_time, element_array_stepsize, node_array_time,
        ...
        return True
    return integrate_system_explicit_asynchronous